# 「外套」— City Pop 的西方基因 · Episode Design Spec

**Date:** 2026-05-10  
**Episode Number:** TBD (next available)  
**Anchor Track:** 中原めいこ — Cloudyな午後  
**Episode Focus:** `translation_aesthetic` (Spec §6 M1 · 基因穿外套)  
**Spec Version:** 0.4  
...
一个可以被耳朵抓住的声音特征——副歌前那一格安静，一口没有完全呼出的气——从 1970s 加州录音室穿越到 1980s 东京，穿在每一代人身上形状不同，但呼吸节律是同一套。

「外套」是这件事的隐喻：西方软摇滚/AOR 的声音语法是一件外套，日本 City Pop 世代各自穿上了它，又各自改了版型。中原めいこ的 Cloudyな午後 是这件外套被改得最轻、最透的那个版本。
...
**留白的处理方式**：不使用精确时间戳。描述可辨认的声音形态——"副歌前那一格什么都没有"，"那个和弦没有落地就已经开始等下一句"——让听者主动在自己耳朵里找。TTS 以正常叙述节奏输出，无需与音乐精确对齐。

**Narrator Persona**：沿用 `near_listener_v1`（参考 Miss You episode）。

**语言风格**：参照现有 episode 写法——短句，具体声音描述，不解释情绪，让音乐本身做解释。

**年份写法**：一九八二年（中文数字，防 TTS 读成数字，参见 feedback memory）。
...
4. 中原めいこ Cloudyな午後 的制作背景（编曲师、录音地点）
...
- `maps/nakahara-meiko_happy-birthday-love-for-you_cloudy-na-gogo.map.json`
- `playlists/nakahara-meiko_happy-birthday-love-for-you_cloudy-na-gogo.playlist.md`
- `episodes/nakahara-meiko_happy-birthday-love-for-you_cloudy-na-gogo.episode.md`（人工审阅版）
- `episodes/nakahara-meiko_happy-birthday-love-for-you_cloudy-na-gogo.episode.json`（TTS 合成清单）
