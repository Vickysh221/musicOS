"""
Build musicos-exhibition/data/exhibition-ep5.json from ep5 source files.

Sources:
  playlists/nakahara-meiko_happy-birthday-love-for-you_cloudy-na-gogo.tracklist.json
  playlists/nakahara-meiko_happy-birthday-love-for-you_cloudy-na-gogo.connections.json
  episodes/nakahara-meiko_happy-birthday-love-for-you_cloudy-na-gogo.episode.json

Run from vault root:
  python3 -m tools.build_ep5_exhibition
"""
...
SLUG = "nakahara-meiko_happy-birthday-love-for-you_cloudy-na-gogo"
AUDIO_FUSION_DIR = ROOT / "musicos-exhibition/public/audio_fusion/ep5"
COVERS_DIR = ROOT / "musicos-exhibition/public/covers"
OUT = ROOT / "musicos-exhibition/data/exhibition-ep5.json"
...
def main() -> None:
    ...
    # Index episode exhibits by position
    ...
    exhibits.append({
        ...
        "fusion_audio_url": f"/audio_fusion/ep5/{stem0}.mp3" if stem0 else None,
    })

    # Positions 1..17 — tracks
    ...
    for pos in range(1, 18):
        ...
        audio_url = f"/audio/ep5/{stem}.mp3" if stem else None
        fusion_url = f"/audio_fusion/ep5/{stem}.mp3" if stem else None
    ...
    # Position 18 — closing
    closing = ep_by_pos[18]
    stem18 = fusion_stem_for_position(18)
    exhibits.append({
        "kind": "narration",
        "position": 18,
        ...
        "narrator_persona_zh": None,
        "narrator_persona_en": None,
        "fusion_audio_url": f"/audio_fusion/ep5/{stem18}.mp3" if stem18 else None,
    })
